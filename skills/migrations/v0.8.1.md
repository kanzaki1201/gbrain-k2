...
Every fact needs inline `^[...]` footnote citations across all skills. Three formats
defined (direct, API/external, synthesis) with source precedence hierarchy.
Legacy `[Source: ...]` format is still recognized by lint and publish but new
pages should use footnote format.
